...
address — mining-style, no ownership proof. Settlement prefers payout_wallet and
falls back to `wallet` for SIWE users who never set a separate one.

Nullable + no backfill: existing accounts keep paying to their identity wallet
(or stay unattributed if they had none) until they set a payout address.
