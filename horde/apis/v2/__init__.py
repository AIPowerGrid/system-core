...
api.add_resource(base.JobProgressUpdate, "/generate/progress")
api.add_resource(stable_styles.ImageStyle, "/styles/image")
api.add_resource(stable_styles.SingleImageStyle, "/styles/image/<string:style_id>")
api.add_resource(stable_styles.SingleImageStyleByName, "/styles/image_by_name/<string:style_name>")
api.add_resource(stable_styles.ImageStyleExample, "/styles/image/<string:style_id>/example")
api.add_resource(stable_styles.SingleImageStyleExample, "/styles/image/<string:style_id>/example/<string:example_id>")
...
api.add_resource(kobold_styles.TextStyle, "/styles/text")
api.add_resource(kobold_styles.SingleTextStyle, "/styles/text/<string:style_id>")
api.add_resource(kobold_styles.SingleImageStyleByName, "/styles/text_by_name/<string:style_name>")
api.add_resource(styles.Collection, "/collections")
api.add_resource(styles.SingleCollection, "/collections/<string:collection_id>")
api.add_resource(styles.SingleCollectionByName, "/collection_by_name/<string:collection_name>")
...
api.add_resource(base.WorkerMessages, "/workers/messages")
api.add_resource(base.SingleWorkerMessage, "/workers/messages/<string:message_id>")
