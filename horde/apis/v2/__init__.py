...
api.add_resource(stable.ImageStyleExample, "/styles/image/<string:style_id>/example")
api.add_resource(stable.SingleImageStyleExample, "/styles/image/<string:style_id>/example/<string:example_id>")
